...
<link rel="stylesheet" href="../CINEMA/loginCheck.css">
</head>
<body>
	<aside class="popup">
		<h1 class="pop_title">로그인 먼저 하시겠습니까?</h1>
		<div class="buttons">
			<button type="button" class="yes"><a href="Login.jsp" id="a">확인</a></button>
			<button type="button" class="no" onclick="MovieList.jsp"><a href="MovieList.jsp" id="a">취소</a></button>
		</div>
	</aside>
	<header>
	...
	<main>
		<section id="content-left">
			<div class="movieSelect">
				<ul>
					<li id="movie"><a class="movItems" onclick="loginCheck.jsp">
							<div>
